    ...
    <div className="flex flex-col h-screen text-twitter-text-primary overflow-hidden">
      ...
      <div className="flex-grow flex p-3 space-x-3 overflow-y-auto">
        ...
        <Textarea
          ...
          className="flex-grow text-lg border-none focus-visible:ring-0 focus-visible:ring-offset-0 p-0 resize-none min-h-[200px] placeholder-twitter-text-secondary"
          value={tweetText}
