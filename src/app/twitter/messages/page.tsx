...
export default function TwitterMessagesPage() {
  const messages = [
    { id: 1, name: "Dev Helper", handle: "devhelp", avatar: "https://placehold.co/48x48.png?text=DH", lastMessage: "Sure, I can help with that!", time: "2m", unread: true },
    { id: 2, name: "Design Team", handle: "designers", avatar: "https://placehold.co/48x48.png?text=DT", lastMessage: "Check out the new mockups.", time: "1h", unread: false },
    { id: 3, name: "Support Bot", handle: "supportbot", avatar: "https://placehold.co/48x48.png?text=SB", lastMessage: "How can I assist you today?", time: "5h", unread: false },
  ];
  return (
    <Sheet>
          ...
          {messages.map(msg => (
            <div key={msg.id} className={`flex items-start space-x-3 p-4 border-b border-twitter-divider ${msg.unread ? 'bg-twitter-primary/5':''}`}>
              <Avatar className="h-10 w-10">
                <AvatarImage src={msg.avatar} alt={msg.name} data-ai-hint="user avatar" />
