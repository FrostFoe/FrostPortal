      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow overflow-y-auto p-4 pb-16 text-twitter-text-primary">
          <div className="relative mb-4 md:hidden">
            ...
            <Input type="search" placeholder="Search Twitter" className="pl-10 bg-slate-100 border-slate-200 focus:bg-white" />
          </div>
          ...
          <div className="space-y-3 mt-4">
            {[1,2,3,4,5].map(i => (
              <div key={i}>
                <p className="text-twitter-text-secondary text-xs">Trending in YourCountry</p>
                <p className="font-bold text-twitter-text-primary">#PlaceholderTrend{i}</p>
                <p className="text-twitter-text-secondary text-xs">10.{i}K Tweets</p>
              </div>
            ))}
          </div>
        </main>
