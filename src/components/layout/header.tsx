          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="text-primary-foreground hover:bg-primary-foreground/10 focus-visible:ring-offset-primary"
              >
            ...
            <SheetContent
              side="right"
              className="w-[280px] bg-primary text-primary-foreground p-6 flex flex-col"
            >
